...
const AboutText = () => {
  return(
    <Container className='flex flex-row justify-between max-[600px]:flex-col max-[600px]:h-[80vh] max-[600px]:mb-16 mmd:max-lg:p-0'>
        <div className='w-1/2 top-10 relative max-[600px]:w-full '>
