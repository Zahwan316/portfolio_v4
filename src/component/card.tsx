...
const CardProject = (Props:props) => {
  return(
    <div className={`w-[24vw] h-[52vh] max-[600px]:w-full md:max-lg:w-[32vw] md:max-lg:h-[42vh] bg-[#00A9FF] hover:scale-110 rounded-md shadow-md shadow-slate-400 flex flex-col relative  transition`}>
      <div className='w-full h-2/4'>
        <img src={Props.img} className='h-full w-full rounded-t-lg object-fill '/>
      </div>
      <div className='px-4 py-2 min-[1600px]:py-4 min-h-16 text-[#f8f8f8]'>
